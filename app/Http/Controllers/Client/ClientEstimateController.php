    ...
    public function create()
    {
        ...
        return DataTables::of($invoices)
            ...
            ->addColumn('action', function ($row) {
                return '<a href="' . route("client.estimates.download", $row->id) . '" data-toggle="tooltip" data-original-title="Download" class="btn btn-inverse btn-outline"><i class="fa fa-download"></i></a>';
            })
