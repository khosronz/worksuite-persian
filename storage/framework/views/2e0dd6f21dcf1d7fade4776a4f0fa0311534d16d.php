                                                ...
                                                <tr id="row<?php echo e($holidaysArray[$month]['id'][$i]); ?>">
                                                    ...
                                                    <td>
                                                        <?php if($user->can('delete_holiday')): ?>
                                                            <button type="button" onclick="del('<?php echo e($holidaysArray[$month]['id'][$i]); ?>',' <?php echo e($holidaysArray[$month]['date'][$i]); ?>')" href="#" class="btn btn-circle btn-danger">
...
</div><?php /**PATH C:\wamp64\www\worksuite\resources\views/member/holidays/holiday-view.blade.php ENDPATH**/ ?>