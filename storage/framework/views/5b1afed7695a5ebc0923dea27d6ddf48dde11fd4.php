<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li><a href="<?php echo e(route('member.task.index')); ?>" class="waves-effect"><i class="fa fa-tasks"></i> <span class="hide-menu"> <?php echo app('translator')->get('app.menu.tasks'); ?> <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
...
<?php /**PATH C:\wamp64\www\worksuite\resources\views/sections/member_left_sidebar.blade.php ENDPATH**/ ?>