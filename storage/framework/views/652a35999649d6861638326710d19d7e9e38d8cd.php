<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="javascript:;" id="show-add-form" class="btn btn-success btn-sm btn-outline"><i class="fa fa-clock-o"></i> <?php echo app('translator')->get('modules.timeLogs.logTime'); ?></a>
            <ol class="breadcrumb">
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="example">
                    ...
                    <div class="input-daterange input-group" id="date-range">
                        <input type="text" class="form-control" id="start-date" placeholder="<?php echo app('translator')->get('app.startDate'); ?>" value="<?php echo e(\Carbon\Carbon::today()->subDays(7)->format($global->date_format)); ?>" />
                        <span class="input-group-addon bg-info b-0 text-white"><?php echo app('translator')->get('app.to'); ?></span>
                        <input type="text" class="form-control" id="end-date" placeholder="<?php echo app('translator')->get('app.endDate'); ?>" value="<?php echo e(\Carbon\Carbon::today()->format($global->date_format)); ?>" />
                    </div>
                </div>
            </div>
    
            <div class="col-md-12">
                <h5 class="box-title"><?php if($logTimeFor->log_time_for == 'task'): ?>
            ...
            <?php else: ?>
                <input type="hidden" id="employee" value="<?php echo e($user->id); ?>">
            <?php endif; ?>
                            ...
                            <div class="row m-t-30">
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <label class="required"><?php if($logTimeFor->log_time_for == 'task'): ?>
                                                <?php echo app('translator')->get('app.selectTask'); ?>
                                            <?php else: ?>
                                                <?php echo app('translator')->get('app.selectProject'); ?>
                                            <?php endif; ?>
...
<script>
    ...
    function showTable(){
        ...
        var url = '<?php echo e(route('member.all-time-logs.data')); ?>?_token=<?php echo e(csrf_token()); ?>';
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "<?php echo e(route('member.all-time-logs.destroy',':id')); ?>";
...
//        console.log(hours+" "+minutes);
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('member.all-time-logs.store')); ?>',
            container: '#logTime',
            type: "POST",
    ...
    $('#project_id2').change(function () {
        var id = $(this).val();
        var url = '<?php echo e(route('member.all-time-logs.members', ':id')); ?>';
        url = url.replace(':id', id);
        // $('employeeBox').show();
        $.easyAjax({
            url: url,
    ...
    $('#task_id2').change(function () {
        var id = $(this).val();
        var url = '<?php echo e(route('member.all-time-logs.task-members', ':id')); ?>';
        url = url.replace(':id', id);
        // $('employeeBox').show();
        $.easyAjax({
            url: url,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.member-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\worksuite\resources\views/member/time-log/index.blade.php ENDPATH**/ ?>