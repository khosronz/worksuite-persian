                ...
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="alert alert-info col-md-12">
                            ...
                            <div class="col-md-2"><a href="<?php echo e(route('admin.update-settings.index')); ?>"
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <span class="counter"><?php if($counts->totalEmployees > 0): ?><?php echo e(round((($counts->totalTodayAttendance/$counts->totalEmployees)*100), 2)); ?><?php else: ?>
                                            0 <?php endif; ?></span>%
                                ...
                                <div  class="text-center">
                                    <div class="empty-space" style="height: 200px;">
                                        <div class="empty-space-inner">
                                            ...
                                            <div class="title m-b-15"><?php echo app('translator')->get('messages.noEarningRecordFound'); ?>
                                            </div>
                                            <div class="subtitle">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $newTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$newTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li class="list-group-item" data-role="task">
                                            <?php echo e(($key+1)); ?>. <a href="<?php echo e(route('admin.tickets.edit', $newTicket->id)); ?>"
                                                            class="text-danger"> <?php echo e(ucfirst($newTicket->subject)); ?></a>
                                            <i><?php echo e(ucwords($newTicket->created_at->diffForHumans())); ?></i>
                                        </li>
                                        ...
                                        <li class="list-group-item row" data-role="task">
                                            <div class="col-xs-9">
                                                ...
                                                <?php if(!is_null($task->project_id) && !is_null($task->project)): ?>
                                                    <a href="<?php echo e(route('admin.projects.show', $task->project_id)); ?>"
                                                    class="font-12"><?php echo e(ucwords($task->project->project_name)); ?></a>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $pendingLeadFollowUps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$follows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li class="list-group-item row" data-role="task">
                                            <div class="col-xs-9">
                                                ...
                                                <a href="<?php echo e(route('admin.leads.show', $follows->lead_id)); ?>"
                                                class="text-danger"><?php echo e(ucwords($follows->lead->company_name)); ?></a>
                                ...
                                <div class="steamline">
                                    <?php $__empty_1 = true; $__currentLoopData = $projectActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="sl-item">
                                            ...
                                            <div class="sl-right">
                                                <div><h6><a href="<?php echo e(route('admin.projects.show', $activ->project_id)); ?>"
                                                            class="text-danger"><?php echo e(ucwords($activ->project->project_name)); ?>

                                                            :</a> <?php echo e($activ->activity); ?></h6> <span
                            ...
                            <div class="panel-body">
                                <div class="steamline">
                                    <?php $__empty_1 = true; $__currentLoopData = $userActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="sl-item">
                                            <div class="sl-left">
                                                <img src="<?php echo e($activity->user->image_url); ?>" width="40" height="40" alt="user" class="img-circle">
                                            </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a
                                                            href="<?php echo e(route('admin.employees.show', $activity->user_id)); ?>"
                                                            class="text-success"><?php echo e(ucwords($activity->user->name)); ?></a>
                                                    <span class="sl-date"><?php echo e($activity->created_at->diffForHumans()); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\worksuite\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>