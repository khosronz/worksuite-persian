        ...
        <tr>
            <td>
                ...
                @elseif(!is_null($invoice->client_id))
                    <div id="invoiced_to">
                        <small>@lang("modules.invoices.billedTo"):</small>
                        <h2 class="name">{{ ucwords($invoice->client->name) }}</h2>
...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="page-break-inside: avoid;" class="discount">
            ...
            <td class="unit">-{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $discount }}</td>
        </tr>
        @foreach($taxes as $tax)
            <tr style="page-break-inside: avoid;" class="tax">
                ...
                <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ $tax->amount }}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
