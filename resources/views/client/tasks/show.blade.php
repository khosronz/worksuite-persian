...
<div class="r-panel-body">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            @if($task->user->image)
                <img src="{{ asset_url('avatar/'.$task->user->image) }}" class="img-circle" width="30" height="30" alt="">
            @else
                <img src="{{ asset('img/default-profile-2.png') }}" class="img-circle" width="30" height="30" alt="">
            @endif
