                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('client.products.create') }}" class="btn btn-outline btn-success btn-sm">@lang('app.purchase') @lang('app.menu.products') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
