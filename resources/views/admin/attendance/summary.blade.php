...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            class="btn btn-success btn-outline btn-sm pull-right">@lang('modules.attendance.markAttendance') <i class="fa fa-plus"  aria-hidden="true"></i></a>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
               <strong>@lang('app.note'):</strong> <i class="fa fa-star text-warning"></i> <i class="ti-arrow-right"></i> @lang('app.menu.holiday') |  <i class="fa fa-check text-success"></i> <i class="ti-arrow-right"></i> @lang('modules.attendance.present') | <i class="fa fa-times text-danger"></i> <i class="ti-arrow-right"></i> @lang('modules.attendance.absent')
            </div>
        </div>
    </div>
