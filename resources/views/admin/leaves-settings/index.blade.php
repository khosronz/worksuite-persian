                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-xs-12 ">
                                                <div class="form-group">
                                                    <label class="required">@lang('app.add') @lang('modules.leaves.leaveType')</label>
                                            ...
                                            <div class="col-xs-12 ">
                                                <div class="form-group">
                                                    <label class="required">@lang('modules.customFields.label') @lang('modules.sticky.colors')</label>
