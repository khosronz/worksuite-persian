                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"  class="form-control readonly-background" name="invoice_number" readonly id="invoice_number" value="@if(is_null($lastInvoice))1 @else{{ ($lastInvoice) }}@endif">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
