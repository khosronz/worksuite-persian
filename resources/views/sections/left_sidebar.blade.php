        ...
        <ul class="nav" id="side-menu">
            ...
            @foreach($mainMenuSettings as $menu)
                ...
                @if(isset($menu['children']))
                    <li><a href="javascript:;" class="waves-effect"><i class="{{ $menu['icon'] }}"></i> <span class="hide-menu"> {{ $menu['translate_name'] }} <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            @foreach($menu['children'] as $subMenu)
                                {{-- Check module permissions --}}
                                @if(in_array($subMenu['module'], $modules) || $subMenu['module'] == 'visibleToAll')
                                    <li><a href="{{ is_null($subMenu['route']) ? 'javascript:;' : route(trim($subMenu['route'])) }}" class="waves-effect"> <span class="hide-menu">{{ $subMenu['translate_name'] }} </span></a> </li>
                                @endif
                            @endforeach
                        </ul>
                    </li>
                @else
                    ...
                    @if(in_array($menu['module'], $modules) || $menu['module'] == 'visibleToAll')
                        <li><a href="{{ is_null($menu['route']) ? 'javascript:;' : route(trim($menu['route'])) }}" class="waves-effect"><i class="{{ $menu['icon'] }}"></i> <span class="hide-menu">{{ $menu['translate_name'] }} </span></a> </li>
                    @endif
