    ...
    <div id="page-wrapper" style="margin-left: 0px !important;">
        <div class="container-fluid">
            ...
            <div class="row m-l-50 m-t-20">
                ...
                <div class="col-md-4 text-center"><h2 class="">@lang('modules.tasks.taskBoard')</h2></div>
...
<script type="text/javascript">
    ...
    function loadData() {
        ...
        var url = '{{route('front.taskBoardData')}}?startDate=' + startDate + '&endDate=' + endDate + '&clientID=' + clientID + '&assignedBY=' + assignedBY + '&assignedTo=' + assignedTo + '&projectID=' + projectID;
