            ...
            <td>
                <div id="invoiced_to">
                    @if(!is_null($invoice->project_id) && !is_null($invoice->project->client))
                        ...
                        <h2 class="name">{{ ucwords($invoice->project->client->client_details->company_name) or ucwords($invoice->project->client->name) }}</h2>
                    ...
                    @elseif(!is_null($invoice->client_id))
                        <small>@lang("modules.invoices.billedTo"):</small>
                        <h2 class="name">{{ ucwords($invoice->clientdetails->company_name) or ucwords($invoice->client->name) }}</h2>
