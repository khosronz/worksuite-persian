                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company_name" name="company_name" class="form-control" value="{{ $leadDetail->company_name ?? '' }}">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="website" name="website" class="form-control" value="{{ $leadDetail->website ?? '' }}" >
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" value="{{ $leadDetail->address ?? '' }}" id="address"  rows="5" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <!--/span-->
