...
!function (t) {
    ...
    function xt(t) {
        var e, n, i, r, s;
        for (e = 0; e < t.length; e++) for (n = t[e], i = 0; i < n.length; i++) for (r = n[i], r.forwardSegs = [], s = e + 1; s < t.length; s++) It(r, t[s], r.forwardSegs)
    }
    ...
    function zt() {
        ...
        t.each((U.options.events ? [U.options.events] : []).concat(U.options.eventSources || []), function (t, e) {
            ...
            var e, n, i;
            for (e = 0; e < tt.length; e++) if (n = tt[e].events, t.isArray(n)) for (i = 0; i < n.length; i++) N(n[i])
    ...
    var Ot = t.fullCalendar = {version: "3.2.0", internalApiVersion: 8}, At = Ot.views = {};
    ...
    var Ut = /^\s*\d{4}-\d\d$/,
        ...
        qt = e.fn, Zt = t.extend({}, qt), $t = e.momentProperties;
    ...
    Ot.Class = ct, ct.extend = function () {
        ...
        var n, i, r, s = !1;
        if (ft.immediate) for (s = !0, n = [], i = 0; i < e.length; i++) if (r = e[i], r && "function" == typeof r.state && "resolved" === r.state() && "_value" in r) n.push(r._value); else {
    ...
    var Jt = Ot.EmitterMixin = {
        ...
        handleMove: function (t) {
            var e, n = E(t) - this.originX, i = b(t) - this.originY, r = this.minDistance;
    ...
    var se = ct.extend(te, Jt, {
        isTouching: !1, mouseIgnoreDepth: 0, handleScrollProxy: null, bind: function () {
            ...
            var t = this, e = Ot.touchMouseIgnoreWait;
    ...
    var oe = ct.extend(te, {
        ...
        dayMousedown: function (t) {
            var e = this.view;
            e.isSelected || e.selectedEvent || (this.dayClickListener.startInteraction(t), e.opt("selectable") && this.daySelectListener.startInteraction(t, {distance: e.opt("selectMinDistance")}))
        },
        ...
        buildDayClickListener: function () {
            var t, e = this, n = this.view, i = new re(this, {
        ...
        getDayClasses: function (t, e) {
            var n = this.view, i = n.calendar.getNow(), r = ["fc-" + _t[t.day()]];
    ...
    le.mixin({
        ...
        listenToExternalDrag: function (t, e, n) {
            var i, r = this, l = this.view.calendar, a = Dt(t), u = r.externalDragListener = new re(this, {
        ...
        eventsToSegs: function (e, n) {
            ...
            return t.each(r, function (t, e) {
                ...
                if (St(e[0])) for (o = i.invertRanges(o), r = 0; r < o.length; r++) s.push.apply(s, i.eventRangeToSegs(o[r], e[0], n)); else for (r = 0; r < o.length; r++) s.push.apply(s, i.eventRangeToSegs(o[r], e[r], n))
            }), s
        },
    ...
    var ce = Ot.TimeGrid = le.extend(ae, {
        ...
        renderDates: function () {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new ne({
                els: this.colEls,
                isHorizontal: !0
            }), this.slatCoordCache = new ne({els: this.slatEls, isVertical: !0}), this.renderContentSkeleton()
        },
        renderHtml: function () {
        ...
        computeLabelInterval: function (t) {
            var n, i, r;
            for (n = Re.length - 1; n >= 0; n--) if (i = e.duration(Re[n]), r = _(i, t), ot(r) && r > 1) return i;
            return e.duration(t)
        },
        computeEventTimeFormat: function () {
    ...
    var fe = Ot.Calendar = ct.extend({
        ...
        getUnitViewSpec: function (e) {
            var n, i, r;
            if (t.inArray(e, Yt) != -1) for (n = this.header.getViewsWithButtons(), t.each(Ot.views, function (t) {
                n.push(t)
            }), i = 0; i < n.length; i++) if (r = this.getViewSpec(n[i]), r && r.singleUnit == e) return r
        },
        buildViewSpec: function (t) {
            for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], c = [], d = t; d;) i = At[d], r = l[d], d = null, "function" == typeof i && (i = {class: i}), i && (a.unshift(i), u.unshift(i.defaults || {}), s = s || i.duration, d = d || i.type), r && (c.unshift(r), s = s || r.duration, d = d || r.type);
    ...
    var ye = {dataType: "json", cache: !1}, Se = 1;
    ...
    At.basic = {class: Ee}, At.basicDay = {type: "basic", duration: {days: 1}}, At.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    }, At.month = {class: De, duration: {months: 1}, defaults: {fixedWeekCount: !0}};
    ...
    }, xe = 5, Re = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];
    At.agenda = {
        class: Te,
        defaults: {
            allDaySlot: !0,
    ...
    }, At.agendaDay = {type: "agenda", duration: {days: 1}}, At.agendaWeek = {type: "agenda", duration: {weeks: 1}};
    var Ie = de.extend({
    ...
    }, At.listDay = {type: "list", duration: {days: 1}, defaults: {listDayFormat: "dddd"}}, At.listWeek = {
        type: "list",
        duration: {weeks: 1},
    ...
    }, At.listYear = {type: "list", duration: {year: 1}, defaults: {listDayAltFormat: "dddd"}}, Ot
});